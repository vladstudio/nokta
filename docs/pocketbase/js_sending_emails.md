...
Alternatively, you can also apply individual changes by binding to one of the [mailer hooks](about:/docs/js-event-hooks/#mailer-hooks). Here is an example of appending a Record field value to the subject using the `onMailerRecordPasswordResetSend` hook:
