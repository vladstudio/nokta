---
title: "Importing TinyBase | TinyBase"
url: https://tinybase.org/guides/the-basics/importing-tinybase
---
...
However, for a very minimal set of submodules, you may save size by including them piecemeal. If you only wanted a [`Store`](/api/the-essentials/creating-stores/store/) and a [`Metrics`](/api/metrics/interfaces/metrics/metrics/) object, for example, you could import them alone like this:
