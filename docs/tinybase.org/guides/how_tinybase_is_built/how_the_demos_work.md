---
title: "How The Demos Work | TinyBase"
url: https://tinybase.org/guides/how-tinybase-is-built/how-the-demos-work
---

The demos on the TinyBase site deserve a little explanation.

For example, take a look at the [Todo App v1 (the basics)](/demos/todo-app/todo-app-v1-the-basics/) demo. It contains a guide that explains each part of the demo step-by-step, whether HTML, JavaScript, or LESS. And then at the top of the page, the demo actually runs.
...
Finally, some client-side JavaScript makes it possible to launch the demos into CodePen via their pre-fill API.