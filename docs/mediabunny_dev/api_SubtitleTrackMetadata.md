---
url: https://mediabunny.dev/api/SubtitleTrackMetadata
title: SubtitleTrackMetadata | Mediabunny
---

# SubtitleTrackMetadata | Mediabunny
...
```
type SubtitleTrackMetadata = BaseTrackMetadata & {};
```
