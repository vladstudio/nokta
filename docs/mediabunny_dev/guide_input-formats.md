---
url: https://mediabunny.dev/guide/input-formats
title: Input formats | Mediabunny
---

# Input formats | Mediabunny
...
-   When creating an `Input`, they are used to specify the list of supported container formats. See [Creating a new input] for more.
