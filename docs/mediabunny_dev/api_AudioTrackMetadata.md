---
url: https://mediabunny.dev/api/AudioTrackMetadata
title: AudioTrackMetadata | Mediabunny
---

# AudioTrackMetadata | Mediabunny

# AudioTrackMetadata

Additional metadata for audio tracks.

type AudioTrackMetadata = BaseTrackMetadata & {};

See [`BaseTrackMetadata`](./BaseTrackMetadata).
