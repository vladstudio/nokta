---
url: https://mediabunny.dev/api/InputVideoTrack
title: InputVideoTrack | Mediabunny
---

# InputVideoTrack | Mediabunny
...
- [`Input.getPrimaryVideoTrack()`](./Input#getprimaryvideotrack)
- [`Input.getVideoTracks()`](./Input#getvideotracks)
- [`new CanvasSink()`](./CanvasSink#constructor)
- [`new VideoSampleSink()`](./VideoSampleSink#constructor)
