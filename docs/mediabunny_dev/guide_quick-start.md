---
url: https://mediabunny.dev/guide/quick-start
title: Quick start | Mediabunny
---

# Quick start | Mediabunny
...
*   Check out the [Metadata extraction example](/examples/metadata-extraction) for this code in action.
...
*   Check out the [Media player example](/examples/media-player) for a demo built on this use case.
...
*   Check out the [Thumbnail generation example](/examples/thumbnail-generation) for this code in action.
...
*   Check out the [Live recording demo](/examples/live-recording) for this code in action.
...
*   Check out the [File compression example](/examples/file-compression) for this code in action.
