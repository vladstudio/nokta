---
url: https://mediabunny.dev/guide/media-sinks
title: Media sinks | Mediabunny
---

# Media sinks | Mediabunny
...
To read media data, each sink offers a different set of methods. You can call these methods as many times as you want; their calls will be independent since media sinks are stateless.
...
1.  Almost: `CanvasSink` becomes stateful when using a canvas pool.