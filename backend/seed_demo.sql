...
-- Jack (Admin) - ID: qf7sw95hu516y5y - Tech enthusiast, busy professional
...
('chat_emma_jack01', '', '["qf7sw95hu516y5y","emma00000000001"]', datetime('now', '-5 minutes'), 'Can''t wait! See you Saturday 💕', 'emma00000000001', 'qf7sw95hu516y5y', 0, datetime('now', '-25 days'), datetime('now'));

-- Chat 2: Jack + Mike (best friends)
INSERT INTO chats (id, name, participants, last_message_at, last_message_content, last_message_sender, created_by, is_active_call, created, updated) VALUES
('chat_mike_jack01', '', '["qf7sw95hu516y5y","mike00000000001"]', datetime('now', '-20 minutes'), 'lol yeah that''s exactly what happened', 'mike00000000001', 'mike00000000001', 0, datetime('now', '-28 days'), datetime('now'));

-- Chat 3: Jack + Sarah (work colleague)
INSERT INTO chats (id, name, participants, last_message_at, last_message_content, last_message_sender, created_by, is_active_call, created, updated) VALUES
('chat_sarah_jack1', '', '["qf7sw95hu516y5y","sarah0000000001"]', datetime('now', '-2 hours'), 'Perfect, I''ll send the updated specs by EOD', 'sarah0000000001', 'sarah0000000001', 0, datetime('now', '-20 days'), datetime('now'));

-- Chat 4: Jack + Dad
INSERT INTO chats (id, name, participants, last_message_at, last_message_content, last_message_sender, created_by, is_active_call, created, updated) VALUES
('chat_dad_jack001', '', '["qf7sw95hu516y5y","dad000000000001"]', datetime('now', '-4 hours'), 'Love you son. Talk soon.', 'dad000000000001', 'qf7sw95hu516y5y', 0, datetime('now', '-30 days'), datetime('now'));

-- Chat 5: Jack + Mom
INSERT INTO chats (id, name, participants, last_message_at, last_message_content, last_message_sender, created_by, is_active_call, created, updated) VALUES
('chat_mom_jack001', '', '["qf7sw95hu516y5y","mom000000000001"]', datetime('now', '-1 hour'), 'Don''t forget to eat properly! 🍎', 'mom000000000001', 'qf7sw95hu516y5y', 0, datetime('now', '-30 days'), datetime('now'));

-- Chat 6: Jack + Alex (gym buddy)
INSERT INTO chats (id, name, participants, last_message_at, last_message_content, last_message_sender, created_by, is_active_call, created, updated) VALUES
('chat_alex_jack01', '', '["qf7sw95hu516y5y","alex00000000001"]', datetime('now', '-6 hours'), 'See you at 7am then 💪', 'alex00000000001', 'alex00000000001', 0, datetime('now', '-15 days'), datetime('now'));

-- Chat 7: Jack's Quick Notes (self-chat)
INSERT INTO chats (id, name, participants, last_message_at, last_message_content, last_message_sender, created_by, is_active_call, created, updated) VALUES
('chat_notes_jack1', 'Quick Notes', '["qf7sw95hu516y5y"]', datetime('now', '-30 minutes'), 'API endpoint: /api/v2/users - need to test', 'qf7sw95hu516y5y', 'qf7sw95hu516y5y', 0, datetime('now', '-20 days'), datetime('now'));

-- Chat 8: Jack's Todos (self-chat)
INSERT INTO chats (id, name, participants, last_message_at, last_message_content, last_message_sender, created_by, is_active_call, created, updated) VALUES
('chat_todos_jack1', 'Todos', '["qf7sw95hu516y5y"]', datetime('now', '-1 hour'), '✅ Completed: Submit quarterly report', 'qf7sw95hu516y5y', 'qf7sw95hu516y5y', 0, datetime('now', '-18 days'), datetime('now'));

-- Chat 9: Family Group (Jack, Emma, Mom, Dad)
INSERT INTO chats (id, name, participants, last_message_at, last_message_content, last_message_sender, created_by, is_active_call, created, updated) VALUES
('chat_family_grp1', 'Family ❤️', '["qf7sw95hu516y5y","emma00000000001","mom000000000001","dad000000000001"]', datetime('now', '-3 hours'), 'See everyone Sunday!', 'mom000000000001', 'mom000000000001', 0, datetime('now', '-30 days'), datetime('now'));
...
('msg_emja_0000001', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'Hey Em! How was the art class today?', datetime('now', '-2 days'), datetime('now', '-2 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000004', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'That kid gets it! Purple sunflowers are valid', datetime('now', '-2 days', '+10 minutes'), datetime('now', '-2 days', '+10 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000006', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'Yeah, deadline is next week. Stressful but manageable', datetime('now', '-2 days', '+20 minutes'), datetime('now', '-2 days', '+20 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000008', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'Thanks sis ❤️', datetime('now', '-2 days', '+25 minutes'), datetime('now', '-2 days', '+25 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000010', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'Of course! Wouldn''t miss it', datetime('now', '-1 day', '+2 minutes'), datetime('now', '-1 day', '+2 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000011', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'What are we getting her?', datetime('now', '-1 day', '+3 minutes'), datetime('now', '-1 day', '+3 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000013', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'The ceramic one from that artisan shop?', datetime('now', '-1 day', '+12 minutes'), datetime('now', '-1 day', '+12 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000015', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'Perfect. I''ll Venmo you my half', datetime('now', '-1 day', '+18 minutes'), datetime('now', '-1 day', '+18 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000017', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'You''re the best organizer in the family', datetime('now', '-1 day', '+22 minutes'), datetime('now', '-1 day', '+22 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000019', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'Just sent the $60', datetime('now', '-5 hours'), datetime('now', '-5 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000022', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'Awesome! Mom is going to love it', datetime('now', '-3 hours'), datetime('now', '-3 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_emja_0000024', 'chat_emma_jack01', 'qf7sw95hu516y5y', 'text', 'What time should I arrive Saturday?', datetime('now', '-10 minutes'), datetime('now', '-10 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000002', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'Yeah! The compiler is insane', datetime('now', '-3 days', '+2 minutes'), datetime('now', '-3 days', '+2 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000004', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'Already migrated my side project to it', datetime('now', '-3 days', '+8 minutes'), datetime('now', '-3 days', '+8 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000006', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'You know me', datetime('now', '-3 days', '+12 minutes'), datetime('now', '-3 days', '+12 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000008', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'Can''t, got meetings all day', datetime('now', '-2 days', '+5 minutes'), datetime('now', '-2 days', '+5 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000009', 'chat_mike_jack01', 'mike00000000001', 'text', 'F', datetime('now', '-2 days', '+6 minutes'), datetime('now', '-2 days', '+6 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000010', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'Friday?', datetime('now', '-2 days', '+8 minutes'), datetime('now', '-2 days', '+8 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000012', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'Yes! I''ve been wanting to try it', datetime('now', '-2 days', '+12 minutes'), datetime('now', '-2 days', '+12 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000014', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', '12:30?', datetime('now', '-2 days', '+18 minutes'), datetime('now', '-2 days', '+18 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000017', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'What?', datetime('now', '-1 day', '+2 minutes'), datetime('now', '-1 day', '+2 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000019', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'Oh no 😂', datetime('now', '-1 day', '+6 minutes'), datetime('now', '-1 day', '+6 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000021', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'STOP 💀', datetime('now', '-1 day', '+9 minutes'), datetime('now', '-1 day', '+9 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000023', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'Classic PM moment', datetime('now', '-1 day', '+12 minutes'), datetime('now', '-1 day', '+12 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000025', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'That''s the spirit', datetime('now', '-1 day', '+18 minutes'), datetime('now', '-1 day', '+18 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000026', 'chat_mike_jack01', 'mike00000000001', 'text', 'Still on for Friday?', datetime('now', '-3 hours'), datetime('now', '-3 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000027', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'Yeah! See you at the ramen place', datetime('now', '-2 hours'), datetime('now', '-2 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_mija_0000029', 'chat_mike_jack01', 'qf7sw95hu516y5y', 'text', 'Wait you went without me??', datetime('now', '-45 minutes'), datetime('now', '-45 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_saja_0000002', 'chat_sarah_jack1', 'qf7sw95hu516y5y', 'text', 'Yes, sending them over now', datetime('now', '-5 days', '+5 minutes'), datetime('now', '-5 days', '+5 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_saja_0000004', 'chat_sarah_jack1', 'qf7sw95hu516y5y', 'text', 'All good, they''re ready for presentation', datetime('now', '-5 days', '+15 minutes'), datetime('now', '-5 days', '+15 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_saja_0000007', 'chat_sarah_jack1', 'qf7sw95hu516y5y', 'text', 'Which one? The stakeholder sync?', datetime('now', '-3 days', '+3 minutes'), datetime('now', '-3 days', '+3 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_saja_0000009', 'chat_sarah_jack1', 'qf7sw95hu516y5y', 'text', 'I''ll be there', datetime('now', '-3 days', '+8 minutes'), datetime('now', '-3 days', '+8 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_saja_0000011', 'chat_sarah_jack1', 'qf7sw95hu516y5y', 'text', 'That call went better than expected!', datetime('now', '-2 days'), datetime('now', '-2 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_saja_0000013', 'chat_sarah_jack1', 'qf7sw95hu516y5y', 'text', 'Your presentation skills are getting even better', datetime('now', '-2 days', '+8 minutes'), datetime('now', '-2 days', '+8 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_saja_0000015', 'chat_sarah_jack1', 'qf7sw95hu516y5y', 'text', 'Hey, any updates on the Q2 timeline?', datetime('now', '-4 hours'), datetime('now', '-4 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_saja_0000017', 'chat_sarah_jack1', 'qf7sw95hu516y5y', 'text', 'Sounds good. Just planning my sprint', datetime('now', '-3 hours', '+5 minutes'), datetime('now', '-3 hours', '+5 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_saja_0000019', 'chat_sarah_jack1', 'qf7sw95hu516y5y', 'text', 'Appreciate it!', datetime('now', '-2 hours', '+15 minutes'), datetime('now', '-2 hours', '+15 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_daja_0000002', 'chat_dad_jack001', 'qf7sw95hu516y5y', 'text', 'Hi Dad! I''m doing great. Work is busy but I enjoy it', datetime('now', '-4 days', '+30 minutes'), datetime('now', '-4 days', '+30 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_daja_0000004', 'chat_dad_jack001', 'qf7sw95hu516y5y', 'text', 'Sort of! We use some AI tools in our workflow', datetime('now', '-4 days', '+50 minutes'), datetime('now', '-4 days', '+50 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_daja_0000006', 'chat_dad_jack001', 'qf7sw95hu516y5y', 'text', 'How''s the garden coming along?', datetime('now', '-4 days', '+60 minutes'), datetime('now', '-4 days', '+60 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_daja_0000008', 'chat_dad_jack001', 'qf7sw95hu516y5y', 'text', 'I can''t wait! Her sauce is the best', datetime('now', '-4 days', '+70 minutes'), datetime('now', '-4 days', '+70 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_daja_0000010', 'chat_dad_jack001', 'qf7sw95hu516y5y', 'text', 'Of course! Already have it in my calendar', datetime('now', '-2 days', '+20 minutes'), datetime('now', '-2 days', '+20 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_daja_0000012', 'chat_dad_jack001', 'qf7sw95hu516y5y', 'text', 'My lips are sealed 🤐', datetime('now', '-2 days', '+30 minutes'), datetime('now', '-2 days', '+30 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_daja_0000014', 'chat_dad_jack001', 'qf7sw95hu516y5y', 'text', 'They''re called emojis! I''ll show you when I visit', datetime('now', '-2 days', '+40 minutes'), datetime('now', '-2 days', '+40 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_daja_0000016', 'chat_dad_jack001', 'qf7sw95hu516y5y', 'text', 'Anytime Dad!', datetime('now', '-6 hours'), datetime('now', '-6 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000002', 'chat_mom_jack001', 'qf7sw95hu516y5y', 'text', 'Yes mom, don''t worry! I cooked yesterday', datetime('now', '-3 days', '+10 minutes'), datetime('now', '-3 days', '+10 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000004', 'chat_mom_jack001', 'qf7sw95hu516y5y', 'text', 'Actually made that chicken recipe you taught me!', datetime('now', '-3 days', '+20 minutes'), datetime('now', '-3 days', '+20 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000006', 'chat_mom_jack001', 'qf7sw95hu516y5y', 'text', 'Turned out pretty good if I say so myself', datetime('now', '-3 days', '+30 minutes'), datetime('now', '-3 days', '+30 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000009', 'chat_mom_jack001', 'qf7sw95hu516y5y', 'text', 'Sounds delicious! Can''t wait to try it', datetime('now', '-2 days', '+15 minutes'), datetime('now', '-2 days', '+15 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000011', 'chat_mom_jack001', 'qf7sw95hu516y5y', 'text', 'Wouldn''t miss your birthday for anything!', datetime('now', '-2 days', '+25 minutes'), datetime('now', '-2 days', '+25 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000013', 'chat_mom_jack001', 'qf7sw95hu516y5y', 'text', 'Too late, already got you something 😊', datetime('now', '-2 days', '+35 minutes'), datetime('now', '-2 days', '+35 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000015', 'chat_mom_jack001', 'qf7sw95hu516y5y', 'text', 'I learned from the best', datetime('now', '-2 days', '+45 minutes'), datetime('now', '-2 days', '+45 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000016', 'chat_mom_jack001', 'mom000000000001', 'text', 'How''s work going honey?', datetime('now', '-5 hours'), datetime('now', '-5 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000017', 'chat_mom_jack001', 'qf7sw95hu516y5y', 'text', 'Busy but good! Big project wrapping up next week', datetime('now', '-4 hours'), datetime('now', '-4 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000019', 'chat_mom_jack001', 'qf7sw95hu516y5y', 'text', 'Thanks mom ❤️', datetime('now', '-2 hours'), datetime('now', '-2 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_moja_0000021', 'chat_mom_jack001', 'qf7sw95hu516y5y', 'text', 'Getting my 7 hours, promise!', datetime('now', '-1 hour', '+15 minutes'), datetime('now', '-1 hour', '+15 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_alja_0000002', 'chat_alex_jack01', 'qf7sw95hu516y5y', 'text', 'Definitely! What time works?', datetime('now', '-3 days', '+5 minutes'), datetime('now', '-3 days', '+5 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_alja_0000004', 'chat_alex_jack01', 'qf7sw95hu516y5y', 'text', '6am is fine, I''m an early bird', datetime('now', '-3 days', '+15 minutes'), datetime('now', '-3 days', '+15 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_alja_0000006', 'chat_alex_jack01', 'qf7sw95hu516y5y', 'text', 'RIP my legs', datetime('now', '-3 days', '+25 minutes'), datetime('now', '-3 days', '+25 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_alja_0000008', 'chat_alex_jack01', 'qf7sw95hu516y5y', 'text', 'Great workout today! Those squats were brutal', datetime('now', '-2 days'), datetime('now', '-2 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_alja_0000010', 'chat_alex_jack01', 'qf7sw95hu516y5y', 'text', 'Almost! 5 lbs away', datetime('now', '-2 days', '+15 minutes'), datetime('now', '-2 days', '+15 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_alja_0000012', 'chat_alex_jack01', 'qf7sw95hu516y5y', 'text', 'Hey, up for gym again this week?', datetime('now', '-8 hours'), datetime('now', '-8 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_alja_0000013', 'chat_alex_jack01', 'alex00000000001', 'text', 'Always! Thursday work?', datetime('now', '-7 hours'), datetime('now', '-7 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_alja_0000014', 'chat_alex_jack01', 'qf7sw95hu516y5y', 'text', 'Thursday 7am?', datetime('now', '-6 hours', '+30 minutes'), datetime('now', '-6 hours', '+30 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000001', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Remember to check the new PocketBase docs', datetime('now', '-10 days'), datetime('now', '-10 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000002', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Ideas for the weekend project: real-time dashboard, maybe use WebSockets', datetime('now', '-8 days'), datetime('now', '-8 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000003', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Meeting notes: Client wants mobile-first design, deadline Q2', datetime('now', '-6 days'), datetime('now', '-6 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000004', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Book recommendation from Mike: "Clean Code" - add to reading list', datetime('now', '-5 days'), datetime('now', '-5 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000005', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Password reset flow might have a bug - investigate Monday', datetime('now', '-4 days'), datetime('now', '-4 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000006', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Potential tech stack for next project: Bun + Hono + React', datetime('now', '-3 days'), datetime('now', '-3 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000007', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Blog post idea: "Why I switched from Redux to Jotai"', datetime('now', '-2 days'), datetime('now', '-2 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000008', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Conference talk abstracts due March 15', datetime('now', '-1 day'), datetime('now', '-1 day'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000009', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Dentist appointment: March 22 @ 2pm', datetime('now', '-12 hours'), datetime('now', '-12 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000010', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Gift for mom: tea set (split with Emma ✓)', datetime('now', '-6 hours'), datetime('now', '-6 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000011', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'Car registration expires end of month - renew online', datetime('now', '-2 hours'), datetime('now', '-2 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_note_0000012', 'chat_notes_jack1', 'qf7sw95hu516y5y', 'text', 'API endpoint: /api/v2/users - need to test', datetime('now', '-30 minutes'), datetime('now', '-30 minutes'));

-- ============ CHAT: Todos (Self) - 15 messages ============
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000001', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '📋 Weekly Goals:', datetime('now', '-7 days'), datetime('now', '-7 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000002', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '☐ Finish API documentation', datetime('now', '-7 days', '+1 minute'), datetime('now', '-7 days', '+1 minute'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000003', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '☐ Review PRs from team', datetime('now', '-7 days', '+2 minutes'), datetime('now', '-7 days', '+2 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000004', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '☐ Fix the auth bug', datetime('now', '-7 days', '+3 minutes'), datetime('now', '-7 days', '+3 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000005', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '✅ Completed: Finish API documentation', datetime('now', '-5 days'), datetime('now', '-5 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000006', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '✅ Completed: Review PRs from team', datetime('now', '-4 days'), datetime('now', '-4 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000007', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '✅ Completed: Fix the auth bug', datetime('now', '-3 days'), datetime('now', '-3 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000008', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '📋 This Week:', datetime('now', '-2 days'), datetime('now', '-2 days'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000009', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '☐ Prepare demo for client', datetime('now', '-2 days', '+1 minute'), datetime('now', '-2 days', '+1 minute'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000010', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '☐ Mom''s birthday gift (tea set)', datetime('now', '-2 days', '+2 minutes'), datetime('now', '-2 days', '+2 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000011', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '☐ Book dentist appointment', datetime('now', '-2 days', '+3 minutes'), datetime('now', '-2 days', '+3 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000012', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '☐ Submit quarterly report', datetime('now', '-2 days', '+4 minutes'), datetime('now', '-2 days', '+4 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000013', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '✅ Completed: Mom''s birthday gift (paid Emma)', datetime('now', '-5 hours'), datetime('now', '-5 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000014', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '✅ Completed: Book dentist appointment', datetime('now', '-3 hours'), datetime('now', '-3 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_todo_0000015', 'chat_todos_jack1', 'qf7sw95hu516y5y', 'text', '✅ Completed: Submit quarterly report', datetime('now', '-1 hour'), datetime('now', '-1 hour'));
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_fam_00000003', 'chat_family_grp1', 'qf7sw95hu516y5y', 'text', 'Hey everyone!', datetime('now', '-5 days', '+10 minutes'), datetime('now', '-5 days', '+10 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_fam_00000008', 'chat_family_grp1', 'qf7sw95hu516y5y', 'text', 'Save some for me! 🍝', datetime('now', '-5 days', '+35 minutes'), datetime('now', '-5 days', '+35 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_fam_00000011', 'chat_family_grp1', 'qf7sw95hu516y5y', 'text', 'Same! It''s going to be great', datetime('now', '-4 days', '+5 minutes'), datetime('now', '-4 days', '+5 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_fam_00000017', 'chat_family_grp1', 'qf7sw95hu516y5y', 'text', 'I''ll bring wine', datetime('now', '-4 days', '+35 minutes'), datetime('now', '-4 days', '+35 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_fam_00000019', 'chat_family_grp1', 'qf7sw95hu516y5y', 'text', 'Already on my list 👍', datetime('now', '-4 days', '+45 minutes'), datetime('now', '-4 days', '+45 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_fam_00000024', 'chat_family_grp1', 'qf7sw95hu516y5y', 'text', '5pm works for me too', datetime('now', '-2 days', '+20 minutes'), datetime('now', '-2 days', '+20 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_fam_00000027', 'chat_family_grp1', 'qf7sw95hu516y5y', 'text', 'Ooh share a pic!', datetime('now', '-1 day', '+5 minutes'), datetime('now', '-1 day', '+5 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_fam_00000031', 'chat_family_grp1', 'qf7sw95hu516y5y', 'text', 'Got the wine! Found a really nice 2019 vintage', datetime('now', '-8 hours'), datetime('now', '-8 hours'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_fam_00000036', 'chat_family_grp1', 'qf7sw95hu516y5y', 'text', '100%!', datetime('now', '-5 hours', '+10 minutes'), datetime('now', '-5 hours', '+10 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
('msg_fam_00000039', 'chat_family_grp1', 'qf7sw95hu516y5y', 'text', 'Same! Can''t wait', datetime('now', '-3 hours', '+30 minutes'), datetime('now', '-3 hours', '+30 minutes'));
INSERT INTO messages (id, chat, sender, type, content, created, updated) VALUES
...
UPDATE messages SET reactions = '{"😂":["qf7sw95hu516y5y","emma00000000001"]}' WHERE id = 'msg_emja_0000003';
UPDATE messages SET reactions = '{"💀":["mike00000000001"]}' WHERE id = 'msg_mija_0000021';
UPDATE messages SET reactions = '{"😂":["qf7sw95hu516y5y"]}' WHERE id = 'msg_mija_0000020';
UPDATE messages SET reactions = '{"👍":["sarah0000000001"]}' WHERE id = 'msg_saja_0000004';
UPDATE messages SET reactions = '{"❤️":["qf7sw95hu516y5y"]}' WHERE id = 'msg_moja_0000005';
UPDATE messages SET reactions = '{"💪":["qf7sw95hu516y5y"]}' WHERE id = 'msg_alja_0000007';
UPDATE messages SET reactions = '{"❤️":["qf7sw95hu516y5y","emma00000000001","dad000000000001"]}' WHERE id = 'msg_fam_00000020';
UPDATE messages SET reactions = '{"🎂":["qf7sw95hu516y5y","mom000000000001","dad000000000001"]}' WHERE id = 'msg_fam_00000026';

-- ============================================
-- Mark some messages as favorites
-- ============================================
UPDATE messages SET favs = '["qf7sw95hu516y5y"]' WHERE id = 'msg_note_0000003';
UPDATE messages SET favs = '["qf7sw95hu516y5y"]' WHERE id = 'msg_note_0000006';
UPDATE messages SET favs = '["qf7sw95hu516y5y"]' WHERE id = 'msg_saja_0000004';
